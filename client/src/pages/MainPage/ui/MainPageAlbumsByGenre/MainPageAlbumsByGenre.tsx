...
export const MainPageAlbumsByGenre = memo((props:MainPageAlbumsByGenreProps) => {
    ...
    return (
        <DynamicReducerLoader reducers={reducers}>
            <VStack className={classNames(cls.mainPageAlbumsByGenre, {}, [className])} gap="16">
                <HStack justify="between" gap="32">
                    <Text title={t('Лучшие альбомы из жанра:')} />
                    <GenreSelector value={genre?.name} onChange={onChangeGenre} />
                </HStack>
